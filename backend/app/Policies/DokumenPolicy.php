...
class DokumenPolicy
{
    ...
    {
        return $user->can('force_delete_dokumen');
    }
    ...
    {
        return $user->can('force_delete_any_dokumen');
    }
    ...
    {
        return $user->can('restore_dokumen');
    }
    ...
    {
        return $user->can('restore_any_dokumen');
    }
    ...
    {
        return $user->can('replicate_dokumen');
    }
    ...
    {
        return $user->can('reorder_dokumen');
    }
}
